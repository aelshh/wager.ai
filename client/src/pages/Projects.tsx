      ...
      <div className="flex  max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar">
        ...
        <div className="flex items-center  justify-end gap-3 flex-1 text-xs sm:text-sm">
          <button
            onClick={saveProject}
            disabled={isSaving}
            className="bg-gray-800 max-sm:hidden hover:bg-gray-700 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors border border-gray-700"
          >
            {isSaving ? (
          ...
          <button
            ...
            className="bg-linear-to-br from-blue-700 to-blue-600 hover:from-blue-600 hover:to-blue-500 text-white px-3.5 py-1 flex gap-2 items-center rounded sm:rounded-sm transition-colors "
          >
            <ArrowBigDownDashIcon size={16} /> Downlaod
          </button>
          <button
          ...
          >
            {project.isPublished ? <EyeOffIcon size={16} /> : <EyeIcon />}{" "}
