...
const EditorPanel = ({ selectedElement, onUpdate, onClose }: EditorPanel) => {
      ...
      <div className="space-y-4 text-black">
        ...
        <div>
          ...
          <input
            ...
            className="w-full text-sm p-2 border border-gray-400 rounded-md foucs:ring-2  focus:ring-indigo-500 outline-none "
          />
        </div>
