...
const Sidebar = ({
  ...
  const handleRollbackVer = async (versionId: string) => {};
  ...
  }, [isGenerating, project.conversation.length]);
  return (
    <div
            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                return (
                  ...
                  >
                    {!isUser && (
                      <div className="w-8 rounded-full bg-linear-to-br form-indig-600 to-indig-700 flex items-center  justify-center">
                  ...
                  <div className="w-4/5 mx-auto my-2 p-3 rounded-xl bg-gray-800 text-gray-100 shadow flex flex-col gap-2">
                    ...
                    <div className="flex items-center justify-between">
                      {project.current_version_index === ver.id ? (
                        ...
                        <button
                          onClick={() => handleRollbackVer(ver.id)}
                          className="px-3 py-1 rounded-md text-xs bg-indigo hover:bg-indigo-600 text-white"
                        >
